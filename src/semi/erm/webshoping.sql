...
DROP TABLE POINTS_CHARGE_HISTORY CASCADE CONSTRAINTS;
DROP TABLE POINTS_CONSUME_HISTORY CASCADE CONSTRAINTS;
...
(
	...
	ADDRESS_FIX varchar2(10) DEFAULT '고정대기',
	ADDRESS_NAME varchar2(50),
	ADDRESS_RECI varchar2(50),
	ADDRESS_tel varchar2(30),
	ADDRESS_ADD varchar2(500),
...
(
	...
	CUSTOMER_ADDRESS_1 varchar2(300) NOT NULL,
	CUSTOMER_ADDRESS_2 varchar2(300) NOT NULL,
...
CREATE TABLE POINTS_CHARGE_HISTORY
(
	CONSUME_AMOUNT number(7,0),
	ORDER_NO number(7,0) NOT NULL
);


CREATE TABLE POINTS_CONSUME_HISTORY
(
	CONSUME_AMOUNT number(7,0),
	ORDER_NO number(7,0) NOT NULL
);
...
(
	QUESTION_TYPE_NO number(4,0) NOT NULL,
	QEUSTION_NO number(7,0) NOT NULL,
	QUESTION_TYPE_NAME varchar2(50),
	PRIMARY KEY (QUESTION_TYPE_NO)
);
...
(
	CUSTOMER_NO number(7,0) NOT NULL,
	SHIPPING_RECEIVER_NAME varchar2(100) NOT NULL,
	SHIPPING_POSTCODE varchar2(30) NOT NULL,
	SHIPPING_ADDRESS_1 varchar2(300) NOT NULL,
	SHIPPING_ADDRESS_2 varchar2(300) NOT NULL,
	SHIPPING_TEL varchar2(100) NOT NULL,
	SHIPPING_MESSAGE varchar2(300)
);
...
ALTER TABLE POINTS_CHARGE_HISTORY
	ADD FOREIGN KEY (ORDER_NO)
	REFERENCES ORDERS (ORDER_NO)
;


ALTER TABLE POINTS_CONSUME_HISTORY
	ADD FOREIGN KEY (ORDER_NO)
	REFERENCES ORDERS (ORDER_NO)
;
