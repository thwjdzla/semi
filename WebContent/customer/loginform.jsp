...
<form id="joinForm" name="joinForm"  onsubmit="return CheckForm(this);" onsubmit="return confirm(this);" onsubmit="return passwordCheckk();" action="addcustomer.jsp" method="post"  >
	...
	<caption></caption>
        <tbody>
			...
			<tr>
                ...
                <td><input id="cust_password" name="cust_password" maxlength="16" value="" type="password" onkeyup="passwordCheckk()" /> (영문 대소문자/숫자 4자~16자)</td>
            	<td id="pwsame" style="color:red;"></td>
            </tr>
			<tr>
				<th scope="row">비밀번호 확인 </th>
                <td><input id="cust_password2" name="cust_password2"   maxlength="16" value="" type="password" onkeyup="passwordCheckk()" /></td>
            </tr>
            <% 
...
<h3>개인정보 취급 위탁 동의(선택)</h3>
	...
	<div class="btnArea center">
        ...
        <input type="submit" class="btn btn-primary" onclick="confirm()" id="submit" value="등록" />
