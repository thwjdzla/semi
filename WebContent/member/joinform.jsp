...
function confirmid() {
	...
	url = "idDuplicationCheck.jsp?cust_id="+document.joinForm.cust_id.value;
	open(url,"confirm",
...
<style type="text/css">
.my-box2{ border:1px solid; padding:10px;  }
</style>

<style type="text/css">
.my-box3 { border:1px solid; padding:10px; }
</style>

<style type="text/css">
.my-box4{ border:1px solid; padding:10px;  }
</style>
...
function confirm(joinForm) {
	...
	var chk1=document.joinForm.U_checkAgreement1.checked;
	var chk2=document.joinForm.U_checkAgreement2.checked;

	var regType1 = /^[A-za-z0-9]{5,15}/g;
	var regType2 = /[~!@#$%^&*()_+|<>?:{}]/;
	var regType3 = /^[A-za-z0-9]{4,16}/g;
	var regType4 = /[ㄱ-ㅎ|ㅏ-ㅣ|가-힣]/;
	var regType5 = /^[A-za-z0-9 | ㄱ-ㅎ|ㅏ-ㅣ|]/g;
	var regType6 = /^[0-9]|-{4}/;
	var regType7 = /^[A-za-z0-9]/g;
	...
	if (regType4.test(document.getElementById('cust_id').value)||!regType1.test(document.getElementById('cust_id').value)||regType2.test(document.getElementById('cust_id').value)) { 
		alert('5~15자내로 영어와 숫자를 이용해 입력해주세요'); 
		return false;
	...
	if (regType4.test(document.getElementById('cust_password').value)||!regType3.test(document.getElementById('cust_password').value)) { 
		alert('4~16자내로 영어와 숫자를 이용해 입력해주세요'); 
		return false;
	...
	if (regType5.test(document.getElementById('cust_name').value)||regType2.test(document.getElementById('cust_name').value)) { 
		alert('2~4자의 한글로만입력해주세요'); 
		return false;
	...
	if (!regType6.test(document.getElementById('cust_phone2').value)) { 
		alert('숫자만입력해주세요'); 
		return false;
	...
	if (!regType6.test(document.getElementById('cust_phone3').value)) { 
		alert('숫자만입력해주세요'); 
		return false;
	...
	if (regType4.test(document.getElementById('cust_email').value)||!regType7.test(document.getElementById('cust_email').value)) { 
		alert('영어와 숫자를 이용해 입력해주세요'); 
		return false;
...
<form id="joinForm" name="joinForm"  onsubmit="return confirm(this);" action="join.jsp" method="post"  >
...
<h5  style="text-align:left"  >기본정보</h5>
	...
	<caption></caption>
        <tbody>
			<tr>
				<th scope="row">아이디 </th>
                <td><input type="text" name="cust_id"  class="" value=""  id="cust_id"  />
           ...
           <%   for(PasswordHint p : passwordHint) {
			...
			<tr>
                ...
                <td><input id="cust_passwordconfirm" name="cust_ane" class="inputTypeText"  value="" type="text"  /></td>
            </tr>
			<tr>
				<th scope="row" id="nameTitle">이름 </th>
                <td>
                    <span id="nameContents"><input id="cust_name" name="cust_name"  class="ec-member-name" maxlength="30" value="" type="text"  /></span>
                </td>
            </tr>
			<tr id="nation">
			<tr>
				<th scope="row">주소 </th>
                <td>
                <input type="text" id="loanPostNo" name="cust_addres"  readonly="readonly"><img src="http://img.echosting.cafe24.com/skin/base_ko_KR/member/btn_zipcode.gif" alt="우편번호" onclick="execDaumPostcode()" /><br/> 	
      			<input type="text" id="loanAddr1" name="cust_addres1"  readonly="readonly"> <br>
				<input type="text" id="loanAddr2" name="cust_addres2" > <br>
                </td>
            </tr>
			<tr>			
           	 </tr>
			 <tr>
				<th scope="row">휴대전화 </th>
					...
					<option value="019">019</option>
						</select>-<input id="cust_phone2" name="cust_phone2" maxlength="4" value="" type="text"  />-<input id="cust_phone3" name="cust_phone3" maxlength="4"  value="" type="text"  /></td>
            </tr>
			<tr class="">
				...
				<tr>
					<th scope="row">이메일 </th>
               			 <td><input id="cust_email" name="cust_email"  value="" type="text"  />@<input id="email2" name="cust_email2" value= "" type="text"  /><select id="emailSelection" name="emailSelection">
