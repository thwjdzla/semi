...
<%
		...
		%>
			<script>
			alert("회원정보가 올바르지 않거나 이미 탈퇴된회원입니다");
         ...
         <p style="font-weight:bold; padding-bottom:10px; color: #333;">MEMBER LOGIN</p>
 		 ...
 		 <p class="security">
            ...
            <div class="join-btn">
                ...
                <a href="joinform.jsp">join us</a>
            </div>
       <p style="margin: 10px auto 0;">
             <a href="find_id.jsp" style="color: #333;">FIND ID</a> /
             <a href="find_passwd_info.jsp" style="color: #333;">FIND PASSWORD</a>
       </p>
       </div>
       </fieldset>
       </div>
