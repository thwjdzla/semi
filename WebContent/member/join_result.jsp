...
<body>
<h5 align="center" style= "padding-top: 350px;">회원가입이 완료되었습니다</h5>

<div class="container" align="center" >
	<div class="my-box" align="center" style= width:400px >
        <div style="text-align:center"  >
        
 		 	<div class="my-box2" align="center" style= width:100% >    
    			<p >저희 쇼핑몰을 이용해 주셔서 감사합니다.</p>
    	    <div class="my-box3" align="center" style= width:60%	>  
    			<ul>
					<li>
						<strong>ID</strong><p> <%=customer.getId() %></p>
					</li>
					<li>
						<strong>name</strong><p><%=customer.getName() %></p>
					</li>
					<li>
					 	 <strong>e-mail</strong><p> <%=customer.getEmail() %></p>
					</li>
 				</ul>
 			 </div>
			</div>
