...
.xans-board-listpackage table tbody.notice .subject,
	.xans-board-listpackage table tbody.fixed .subject {
	font-weight: bold;
}
...
.xans-board-listpackage .boardwritebtn {
...
.xans-board-listpackage .boardwritebtn:hover {
	background: #aaa;
	color: #fff;
