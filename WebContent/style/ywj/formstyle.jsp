...
.xans-board-write table tr.first th, .xans-board-write table tr.first td,
	.xans-board-write table tr.ucc th, .xans-board-write table tr.ucc td {
	border-top: 0;
}
...
.xans-board-write table #ucc_width {
	width: 40px;
}
...
.xans-board-write table input[type=radio], .xans-board-write table input[type=checkbox],
	.xans-board-write table #notice0, .xans-board-write table #secure0,
	.xans-board-write table #secure1, .xans-board-write table #privacy_agreement_radio0,
	.xans-board-write table #privacy_agreement_radio1 {
	border: 0;
	width: 13px;
	height: 13px;
	margin: 0 3px 0 0;
...
.xans-board-write .btnArea .boardbtn {
	padding-right: 3px;
}
